...
public class matroska_tnt extends UberItem {

    public matroska_tnt(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
    ...
    public boolean rightClickAirAction(Player player, ItemStack item) {
        ...
        tnt.setMetadata("nested", new FixedMetadataValue(UberItems.getInstance(), 3));
