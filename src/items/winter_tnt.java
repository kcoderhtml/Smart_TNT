...
public class winter_tnt extends UberItem {

    public winter_tnt(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
    ...
    public boolean rightClickAirAction(Player player, ItemStack item) {
        ...
        tnt.setMetadata("winter", new FixedMetadataValue(UberItems.getInstance(), "a"));
        tnt.setYield(10);
